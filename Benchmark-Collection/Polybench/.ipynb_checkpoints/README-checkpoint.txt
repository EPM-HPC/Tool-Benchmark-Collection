...
2. Run "make" in target folder(s) with codes to generate outcutable(s)
3. Run the generated .out file(s).
...
3. Run "make" in target folder(s) to generate outcutable(s)
4. Run the generated .out file(s).
...
4. Run "make out" in target folder(s) with codes to generate outcutable(s)
5. Run generated .out file(s).  If there's an error when running the .out file(s), try running them with the "make" or "make run"
...
within the codes.  After modifying, run "make clean" then "make" on relevant code for modifications to take effect in resulting outcutable.
